...
$(IntermediateDirectory)/Router.cpp$(ObjectSuffix): Router.cpp $(IntermediateDirectory)/Router.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/lieven/workspace/Ebos/Router.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Router.cpp$(ObjectSuffix) $(IncludePath)
